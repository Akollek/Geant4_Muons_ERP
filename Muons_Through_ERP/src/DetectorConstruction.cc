...
{
  // basement: 
  // fAbsorberThickness = 0.845 *m;
  // top floor:
     fAbsorberThickness = 0.357 *m;
  fAbsorberSizeYZ    = 1.*m;
  fXposAbs           = 0.*cm;
...
{ 
  ...
  G4Element* Mg  = new G4Element("Magnesium",  symbol="Mg",  z= 12, a= 24.3050 *g/mole);
  G4Element* Al = new G4Element("Aluminium",  symbol="Al", z=13, a= 26.9815386 *g/mole);
  G4Element* Si = new G4Element("Silicon",   symbol="Si", z=14, a= 28.0855 *g/mole);
  G4Element* K  = new G4Element("Potassium",  symbol="K" , z=19, a= 39.0983 *g/mole);
  G4Element* Ca = new G4Element("Calcium",   symbol="Ca", z=20, a= 40.078 *g/mole);

  G4Material* Concrete = 
    new G4Material("Concrete", density= 2.3*g/cm3, ncomponents=10);
  Concrete->AddElement(H, fractionmass=0.01); //z=1, fr=0.01
  Concrete->AddElement(C, fractionmass=0.001);//z=6, fr=0.001
  Concrete->AddElement(O, fractionmass=0.529107);//z=8, fr=0.529107
  Concrete->AddElement(Na, fractionmass=0.016);//z=11, fr=0.016
  Concrete->AddElement(Mg, fractionmass=0.002);//z=12 fr = 0.002
  Concrete->AddElement(Al, fractionmass=0.033872);//z=13, fr=0.033872
  Concrete->AddElement(Si, fractionmass=0.337021);//z=14, fr=0.337021
  Concrete->AddElement(K, fractionmass=0.013);//z=19, fr=0.013
  Concrete->AddElement(Ca, fractionmass=0.044);//z=20, fr=0.044
  Concrete->AddElement(Fe, fractionmass=0.014);//z=26, fr=0.014
